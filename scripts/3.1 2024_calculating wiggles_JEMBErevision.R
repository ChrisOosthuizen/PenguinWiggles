...
result_all <- data.frame(id = character(), 
                  ...
                  #    SW_one_wig_in_s_e = numeric(),
                  #    SW_all_wig_in_s_e = numeric(),
                  #    SW_all_wig_cooldown = numeric(),
                     wiggle_SW = numeric(),
                     wiggle_SW_bottom = numeric(),
...
source("./scripts/3.4 2024_wiggle_function_Simeone_Wilson_JEMBErevision.R")
wiggleN_Simeone = Simeone_wiggles(subdat, wiggle_threshold = 0.35)
  ...
  result_all <- rbind(result_all, data.frame(id = current_id,
                                      ...
                                      #     wiggleN_Simeone = wiggleN_Simeone$wiggleN_Simeone,
                                       #    SW_one_wig_in_s_e = wiggleN_Simeone$SW_one_wig_in_s_e,
                                       #    SW_all_wig_in_s_e = wiggleN_Simeone$SW_all_wig_in_s_e,
                                       #    SW_all_wig_cooldown = wiggleN_Simeone$SW_all_wig_cooldown,
                                      wiggle_SW = wiggleN_Simeone$wiggle_SW,
                                      wiggle_SW_bottom = wiggleN_Simeone$wiggle_SW_bottom,
...
# Save the output
#-------------------
saveRDS(result_all, "./output/result_all_3m_JEMBErevision.rds")
saveRDS(subdat_Halsey_1m, "./output/subdat_Halsey_1m_3m.rds")
saveRDS(subdat_Halsey_2m, "./output/subdat_Halsey_2m_3m.rds")
saveRDS(subdat_Simeone, "./output/subdat_Simeone_3m_JEMBErevision.rds")
