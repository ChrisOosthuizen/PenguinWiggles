---
title: "diveMove dive threshold example"
date: "2025-02-01"
output: pdf_document
---
...
example_dive = dives %>%
  ...
  arrange(date.time) %>%
  dplyr::filter(date.time > '2022-01-10 17:53:48') %>%
  dplyr::filter(date.time < '2022-01-10 17:54:44')
...
## 2. Divemove analysis with 0.4 m threshold
