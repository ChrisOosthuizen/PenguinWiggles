...
# Save as PNG
ggsave("./figures/Figure4_points_density.png", figure5, width = 8, height = 6, dpi = 1500)

# Save as PNG
ggsave("./figures/Figure6_bottist.png", fig5_bottdist, width = 4.2, height = 3.35, dpi = 1500)
...
# Save as PNG
ggsave("./supplement/Fig_videoPCE_cumulative_wiggles.png", 
